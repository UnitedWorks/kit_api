module.exports = [
  ...
  {
    intent: 'environment_sanitation.tree.inspection',
    text: 'The tree outside my house looks dead',
  }, {
    intent: 'environment_sanitation.tree.planting',
    text: 'Can we get a new tree on the corner of George Street and College Ave?',
  }, {
    intent: 'environment_sanitation.tree.pruning',
    text: 'A tree outside my house is touching an eletrical wire',
  }, {
    intent: 'environment_sanitation.tree.removal',
    text: 'Can you remove a tree on my street?',
  }, {
    intent: 'environment_sanitation.trash.animals',
    text: 'Rodents keep eating my garbage',
  }, {
    intent: 'environment_sanitation.trash.animals',
    ...
    intent: 'environment_sanitation.trash.collection_missed',
    text: 'My garbage wasnt picked up',
  }, {
    intent: 'environment_sanitation.recycling.collection_missed',
    text: 'My recycling didnt get picked up this morning',
  }, {
    intent: 'environment_sanitation.litter',
    text: 'The sidewalk outside my house is covered in trash',
  }, {
    intent: 'environment_sanitation.park.reservation',
    ...
    intent: 'environment_sanitation.water.flooding',
    text: 'My street is flooding',
  }, {
    intent: 'environment_sanitation.water.flooding',
    text: 'The block is still underwater',
  }, {
    intent: 'environment_sanitation.water.quality',
    ...
    intent: 'environment_sanitation.air.quality',
    text: "there's a thick smog",
  }, {
    intent: 'environment_sanitation.air.quality',
    text: "Our air isn't clean",
  }, {
    intent: 'environment_sanitation.dumping',
    text: 'There is an RV dumping at Malipardis park',
  }, {
    intent: 'environment_sanitation.dumping',
    text: 'Someone is dumping trash behind our house',
  },
  // Health
  {
    ...
    intent: 'health_medicine.standing_water',
    text: 'Water on the street is getting swarmed with mosquitos',
  }, {
    intent: 'health_medicine.animal.rabid',
    text: "There's a rabid skunk down the road",
  }, {
    intent: 'health_medicine.animal.dead',
    ...
    intent: 'health_medicine.animal.excrement',
    text: "My neighbor isn't picking up after his dog",
  }, {
    intent: 'health_medicine.rodents',
    text: 'There are rats eating my garbage',
  }, {
    intent: 'health_medicine.insects.bed_bugs',
    text: 'Help I think I have bed bugs',
  }, {
    intent: 'health_medicine.insects.bees',
    text: 'I think there is a hornets nest in the gutter',
  },
  ...
  // Transportation
  {
    ...
    intent: 'transportation_streets_sidewalks.street.manhole',
    text: "There's a manhole cover loose",
  }, {
    intent: 'transportation_streets_sidewalks.street.fire_hydrant',
    text: 'A fire hydrant is spraying water wildly all over the street',
  }, {
    intent: 'transportation_streets_sidewalks.street.blocked',
    text: 'How do I report a basketball hoop blocking a street?',
  }, {
    intent: 'transportation_streets_sidewalks.driveway',
    ...
    intent: 'transportation_streets_sidewalks.sidewalk',
    text: 'How do I request a sidewalk inspection to remove a violation?',
  }, {
    intent: 'transportation_streets_sidewalks.sidewalk.broken',
    ...
    intent: 'transportation_streets_sidewalks.sign.broken',
    ...
    intent: 'transportation_streets_sidewalks.sign.conflict',
    text: 'These signs dont make any sense',
  }, {
    intent: 'transportation_streets_sidewalks.sign.conflict',
    text: 'How do I know what a parking sign means?',
  }, {
    intent: 'transportation_streets_sidewalks.sign.down',
    text: 'This street sign fell down',
  }, {
    intent: 'transportation_streets_sidewalks.sign.request',
    ...
    intent: 'transportation_streets_sidewalks.signal.burnt_out',
    text: 'None of the traffic lights work',
  }, {
    intent: 'transportation_streets_sidewalks.signal.flickering',
    text: 'The traffic light is going on and off',
  }, {
    intent: 'transportation_streets_sidewalks.signal.down',
    text: 'the traffic light has fallen down',
  }, {
    intent: 'transportation_streets_sidewalks.signal.request',
    ...
    intent: 'transportation_streets_sidewalks.street_light.flickering',
    text: 'A street light at the corner is flickering',
  }, {
    intent: 'transportation_streets_sidewalks.street_light.down',
    text: 'A whole street light just came down outside my apartment',
  }, {
    intent: 'transportation_streets_sidewalks.street_light.request',
    text: 'The street along College Ave. isnt well lit. Can we get more lights?',
  }, {
    intent: 'transportation_streets_sidewalks.parking_violation',
    ...
    intent: 'transportation_streets_sidewalks.parking_violation.blocking',
    ...
    intent: 'transportation_streets_sidewalks.parking_violation.handicap',
    ...
    intent: 'transportation_streets_sidewalks.construction.noise',
    ...
    intent: 'transportation_streets_sidewalks.vehicle.wreckless',
