...
const updateOperations = [
  ...
  { from: 'health_medicine.animal_rabbies_found', to: 'health_medicine.animal.rabbies.expect' },
  ...
  { from: 'property_buildings_homes.property_landlord_requirements_heating', to: 'property_buildings_homes.responsibility.heating' },
  ...
  { from: 'property_buildings_homes.public_housing_maintenance.report', to: 'property_buildings_homes.housing_violation.repairs.housing.public' }, // Created a shout for this
  ...
  { from: 'transportation_streets_sidewalks.plow_schedule', to: 'transportation_streets_sidewalks.plow.schedule' },
  ...
  { from: 'interaction.tasks.get', to: 'interaction.tasks' },
