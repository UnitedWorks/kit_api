export const i18n = (key, inserts = {}) => {
  const translations = {
    ...
    intro_information: `Can I help you find something? I can answer questions about ${inserts.organizationName ? `${inserts.organizationName} ` : 'local '}government! I can also remind you about trash/recycling pickup, city events, and the weather!`,
