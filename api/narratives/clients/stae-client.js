        ...
        const results = res.data.results.sort((a, b) => {
          ...
          return {
            ...
            payload: {
              ...
              description: `Bike share station with ${station.data.capacity} bicycles ${metersAway} meters away. Operated by ${station.data.operator.slice(0, 1).toUpperCase()}${station.data.operator.slice(1)}.`,
              location: {
                type: 'Point',
                coordinates: [
