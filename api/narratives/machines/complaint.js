...
export default {
  ...
  complaint_submit: {
    enter() {
      ...
      return handleConstituentRequest(complaint.headline, complaint.category, this.snapshot.constituent, this.get('organization') || { id: this.snapshot.organization_id }, complaint.location, complaint.attachments)
        .then(() => {
